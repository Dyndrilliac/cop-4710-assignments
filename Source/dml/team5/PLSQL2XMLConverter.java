...
/**
 * <p>
 * This class converts the relational database output of both unmodified and
 * modified Oracle PL/SQL selection statements into XML.
 * </p>
 * <p>
 * Command-line usage:
 * <code>java {@link dml.team5.PLSQL2XMLConverter} InputString1 InputString2 ... InputStringN</code>
 * </p>
 * <p>
...
public final class PLSQL2XMLConverter extends LanguageConverter {
	/**
	 * <p>
	 * Simple console-based command-line test driver. Each argument is an input
	...
	public static final void main(final String[] args) {
		...
		if (args.length > 0) {
			...
			System.out.println("Usage: " + PLSQL2XMLConverter.class.getSimpleName()
					+ " InputString1 InputString2 ... InputStringN");
	...
	/**
	 * <p>
	 * Constructs a new instance of {@link dml.team5.PLSQL2XMLConverter} based
	 * on an input {@link java.lang.String}.
	 * </p>
	 * 
	 * @param inputString
	 ...
	 *            MySQL database.
	 * @param isDebugMode
	 *            true to print the SQL table in addition to the XML tags, false
	 *            otherwise.
	 * @param isDTD
	 *            true to use the W3C Data Type Definition (DTD) format, false
	 *            to use the W3C XML Schema Definition (XSD) format.
	 * @since 1.0
	 */
	public PLSQL2XMLConverter(final String inputString, final boolean isOracle, final boolean isDebugMode,
			final boolean isDTD) {
		...
		try {
			...
			// If there is an error, then set the output to a meaningful error
	...
	/**
	 * <p>
	 * Executes the conversion process: parses input, strips out SQL
	 * modifications, connects to database, executes input, and converts the
	 * output into XML.
	 * </p>
	 * 
	 * @throws Exception
	 *             if a database access error occurs, or if a parsing error
	 *             occurs.
	 * @since 1.0
	 */
	@Override
	protected final void convert() throws Exception {
		...
		// Declare variables to keep track of the parse tree, the connection,
		...
		try {
			...
			if (parseTree == null) {
				if (isInputSelect) {
					// If the silent parse fails, set the isModified flag to
					// true.
					...
					// If the input query is modified PL/SQL and a SELECT query,
					// then strip out the modifications and make it unmodified
					// PL/SQL again.
			...
			try {
				...
				// Make a mapping of the database's schema, matching column
	 ...
	 * </p>
	 * <p>
	 * True to use the W3C Data Type Definition (DTD) format, false to use the
	 ...
	 * </p>
	 * <p>
	 * True to use the {@link dml.team5.antlr.ModifiedPLSQLParser}, false to use
	 * the {@link dml.team5.antlr.PLSQLParser}.
	 * </p>
	 * 
	 * @return the value of the isModified flag.
	 * @since 1.1
	 ...
	 * </p>
	 * <p>
	 * True to connect to an Oracle database, false to connect to a MySQL
	 * database.
	 * </p>
	 * 
	 * @return the value of the isOracle flag.
