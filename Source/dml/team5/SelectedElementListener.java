...
/**
 * <p>
 * This helper class walks the {@link org.antlr.v4.runtime.tree.ParseTree} to
 * construct the master SELECTED_ELEMENTS {@link java.util.List}.
 * </p>
 * 
...
public class SelectedElementListener extends PLSQLBaseListener {
	 ...
	 * </p>
	 * <p>
	 * Two possibilities exist: either the selected element is fully qualified
	 * and includes its table name, or it isn't and it doesn't.
	 * </p>
	 * 
	 * @param ctx
	 *            the relevant context generated by the
	 *            {@link dml.team5.antlr.PLSQLParser} for the 'selected_element'
	 *            token.
	...
	public void enterSelected_element(final PLSQLParser.Selected_elementContext ctx) {
		...
		try {
			// If it's fully qualified, just extract the table name and the
			// attribute name.
			...
			// If it's not fully qualified, then we have to do some additional
			// shenanigans.
			else {
