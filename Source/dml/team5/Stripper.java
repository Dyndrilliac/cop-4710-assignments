...
/**
 * <p>
 * This class provides a method to strip out our modifications to the SELECT
 * query SQL syntax.
 * </p>
 * 
...
public class Stripper {
	...
	/**
	 * <p>
	 * This method takes an input {@link java.lang.String}, strips out our SQL
	 * modifications, and then returns the stripped {@link java.lang.String} as
	 * output.
	 * </p>
	 * 
	 * @param input
						...
						if (lc_input.charAt(i + 2) == 'o') {
							...
							if (lc_input.charAt(i + 3) == 'm') {
								...
								if (!Character.isLowerCase(lc_input.charAt(i + 4))) {
									...
									notFrom = true;
									i--;
									// System.out.println("thinks theres more
									// after caught from ");
								}
							} else {
								notFrom = true;
...
// select distinct name as salesperson, <customer, name as custname,
// <custaddress, street, city, phone,>,>, from s, c, orders, p where s = orders
// and c = orders and p = orders;
// select distinct s.sname as salesperson_name, <+ customer, orders.cno as
// customer_no, orders.totqty,> from s, orders where s.sno = orders.sno;
// select distinct faculty.address as address, + faculty.salary as salary from
// faculty;
